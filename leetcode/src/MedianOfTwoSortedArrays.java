...
//        }
//
//        int[] targets = search(nums1, 0, nums2, 0, startIndex, endIndex);
//        return (targets[0] + targets[1]) * 1.0 / 2;
//    }
//    private int[] search(int[] nums1, int start1, int[] nums2, int start2, int startIndex, int endIndex) {
//        System.out.println(start1 + ", " + start2 + ", " + startIndex + ", " + endIndex);
//        int startNum = 0;
//        int endNum = 0;
//        if (nums1.length == 0 || nums2.length == 0 || nums1[nums1.length - 1] <= nums2[start2] || nums2[nums2.length - 1] <= nums1[start1]) {
//            if (nums1.length == 0 || nums2[nums2.length - 1] <= nums1[start1]) {
//                if (startIndex <= nums2.length - 1 - start2) {
//                    startNum = nums2[startIndex + start2];
//                } else {
//                    startNum = nums1[startIndex - nums2.length + start2 + start1];
//                }
//                if (startIndex == endIndex) {
//                    endNum = startNum;
//                } else {
//                    if (endIndex <= nums2.length - 1 - start2) {
//                        endNum = nums2[endIndex + start2];
//                    } else {
//                        endNum = nums1[endIndex - nums2.length + start2 + start1];
//                    }
//                }
//            } else {
//                if (startIndex <= nums1.length - 1 - start1) {
//                    startNum = nums1[startIndex + start1];
//                } else {
//                    startNum = nums2[startIndex - nums1.length + start1 + start2];
//                }
//                if (startIndex == endIndex) {
//                    endNum = startNum;
//                } else {
//                    if (endIndex <= nums1.length - 1 - start1) {
//                        endNum = nums1[endIndex + start1];
//                    } else {
//                        endNum = nums2[endIndex - nums1.length + start1 + start2];
//                    }
//                }
//            }
////            int[] smallNums = nums1.length == 0 ? nums2 : nums2.length == 0 || nums1[nums1.length - 1] <= nums2[start2] ? nums1 : nums2;
////            int[] bigNums = nums1.length == 0 ? nums1 : nums2.length == 0 || nums1[nums1.length - 1] <= nums2[start2] ? nums2 : nums1;
////            if (startIndex <= smallNums.length -1) {
////                startNum = smallNums[startIndex];
////            } else {
////                startNum = bigNums[startIndex - smallNums.length];
...
////            }
//            return new int[]{startNum, endNum};
////        } else if (nums1.length - 1 == start1 || nums2.length - 1 == start2) {
////            int[] nums = nums1.length - 1 == start1 ? nums2 : nums1;
////            int num = nums1.length == 1 ? nums1[0] : nums2[0];
////            int index = Arrays.binarySearch(nums, num);
////            index = index >= 0 ? index : Math.abs(index + 1);
////            if (startIndex < index) {
...
//                for (int i = 0, n = Math.min(nums1.length, 10); i < n; i++) {
//                    list.add(nums1[i + start1]);
//                }
//                for (int i = 0, n = Math.min(nums2.length, 10); i < n; i++) {
//                    list.add(nums2[i + start2]);
//                }
...
//
//                if (median1 <= nums2[0]) {
//                    return search(nums1, medianIndex1 + 1, nums2, 0, startIndex - medianIndex1 - 1, endIndex - medianIndex1 - 1);
//                } else if (median2 <= nums1[0]) {
//                    return search(nums1, 0, nums2, medianIndex2 + 1, startIndex - medianIndex2 - 1, endIndex - medianIndex2 - 1);
//                } else if (median1 <= median2) {
//                    int skipIndex = Arrays.binarySearch(nums2, median1);
//                    skipIndex = skipIndex >= 0 ? skipIndex : Math.abs(skipIndex + 1);
//                    return search(nums1, medianIndex1 + 1, nums2, skipIndex, startIndex - medianIndex1 - skipIndex - 1, endIndex - medianIndex1 - skipIndex - 1);
//                } else {
//                    int skipIndex = Arrays.binarySearch(nums1, median2);
//                    skipIndex = skipIndex >= 0 ? skipIndex : Math.abs(skipIndex + 1);
//                    return search(nums1, skipIndex, nums2, medianIndex2 + 1, startIndex - medianIndex2 - skipIndex - 1, endIndex - medianIndex2 - skipIndex - 1);
//                }
//            }
//        }
//    }
